...
# Hi Learner, While attempting the test, DO NOT EDIT this file. It may result in 0 score.
...
print("\n--------- Train a Machine Learning Model (`train_model.py`) [3 Marks] ---------")
...
print("\n--------- Make Predictions - Inference (`predict.py`) [3 Marks] ---------")
